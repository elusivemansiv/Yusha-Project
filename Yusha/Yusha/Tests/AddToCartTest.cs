...
namespace Yusha.Selenium
{
    ...
    internal class AddToCartTest : BaseTest
    {
        ...
        [AllureDescription("As user I want to Add to Cart a product to the wesbsite with valid Login Data")]
        ...
        [AllureLink("Website", "https://yusha.com.bd/")]
        [AllureSuite("Browser tests")]
        [AllureDescription("As user I want to Add to Cart a product to the wesbsite with Invalid Login Data")]
        public void AddtocartInvalidtest()
        {
            var CategorySection = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//h3[text()='Product Categories']")));
            ((IJavaScriptExecutor)driver).ExecuteScript("arguments[0].scrollIntoView(true);", CategorySection);
            ...
            Thread.Sleep(1000);
            var requiredSignIn = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//div[@class='modal-content']//input[@id='phone_number']")));
            requiredSignIn.SendKeys("00000000000");
            var loginBtn = driver.FindElement(By.XPath("//div[@class='form-group']//span[text()='Login']"));
            loginBtn.Click();
            Thread.Sleep(1000);
        ...
        [AllureLink("Website", "https://yusha.com.bd/")]
        [AllureSuite("Browser tests")]
        [AllureDescription("As user I want to Add to Cart a product to the wesbsite withou Login")]
        public void AddtocartNoLogintest()
        {
            var CategorySection = wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//h3[text()='Product Categories']")));
            ((IJavaScriptExecutor)driver).ExecuteScript("arguments[0].scrollIntoView(true);", CategorySection);
